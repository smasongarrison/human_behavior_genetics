...
title: Course Project, Five Scholarly Source Summaries
...
For this assignment, you will complete structured summaries (following a template) of 5 scholarly sources. The package of summaries that you submit must meet the following minimum criteria:
...
2 hours per summary x 5 sources = 10 hours total. 

This is the LARGEST single milestone (by total time/effort/points) of the Course Project. Plan ahead to spread out your effort - you do NOT want to save this for the day before. 

## Assignment Instructions

In your own words, complete an Article Summary Template for each of 5 scholarly sources related to your Course Project topic. 
...
**Preferably no more than 1 source**: For review articles (that is, papers that summarize previous research with no novel analysis of data), use the [Review Article Summary template](../materials/template_summary_review_source.md). 
...
Please number your article summaries (any order you want, just make it easy for me to refer to in feedback, e.g. "For article 3...") and start each article summary on a new page of your document (this makes it so much easier to grade, and happy graders are generous graders).
