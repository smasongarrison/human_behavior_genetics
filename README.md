...
This course is offered as a half-semester seminar treatment of current theory and research in behavior genetics. Prerequisites: Senior standing, psychology major. The last major update of content was for the Fall 2023 semester; it is currently being revised for the Fall 2025 semester. 
...
- [Part I: Foundations (weeks 1-3)](#part_1)
	- What We Know and What We Don't
	- We've Been Wrong Before
	- Finding and Reading Behavior Genetics Research
- [Part II: Model Phenotypes (weeks 4-5)](#part_2)
	- Height and Ancestry
	- Schizophrenia and Autism
- [Part III: Advanced Topics and Ethics (weeks 6-8)](#part_3)
	- Causal Reasoning in Substance Use and Aggression
	- Science Communication and Genetic Engineering
	- Applications: Medicine, Education, and Society
...
Prerequisites: Senior standing, psychology major. This seminar focuses on engaging with primary research literature through reading, discussion, and critical evaluation of behavior genetics research. 
...
This half-semester seminar is designed as an advanced undergraduate course focused on developing core competencies for critical evaluation of current and future knowledge in behavior genetics. As genetics - especially as related to complex behaviors and experiences - is a constantly developing field, the course emphasizes skill development in accessing, reading, evaluating, and synthesizing primary research literature. There are no exams; the major grade/product is a term paper on any topic of the students' choosing, along with an accompanying piece of public-oriented science communication. The scaffolded process helps students develop specialized expertise in their chosen area.
...
This half-semester seminar meets over 8 weeks. Consistent with an expectation that a course takes about 3 times the number of credits in hours per week, as a 3-credit course, plan to spend an average of 9 hours per week working on this course. Points earned for weekly participation activities and course project assignments are scaled such that each point is expected to take about 1 hour of effort, including time to prepare (e.g. read, think) and complete (e.g. write, edit) the task.

**Grades** are based on the total number of points earned by the end of the semester. Points come from weekly activities (up to five points per week for 8 weeks) and a course project (including four assignments leading up to a term paper, totaling up to 40 points). There are potentially 80 points to be earned throughout the semester.
...
You may notice that the table for converting points into final grades doesn't quite scale at 10% increments (eg. 90% of 80 is 72, but that's exactly what you need for an A). The grading scale is designed to maintain the same standards as the full-semester version while accounting for the compressed timeframe. 
...
Throughout the semester, you will develop a **Course Project** about a topic related to human behavior genetics that is of interest to you, with the goals of identifying, understanding, and synthesizing recent and historic scholarly sources; developing expertise in a specific topic of interest; and communicating knowledge to a general audience. The course project includes four major assignments up to and including the final paper:

- Week 4: [Five Scholarly Source Summaries](week_04/course_project_five_scholarly_source_summaries.md) (10 points)
- Week 6: [Draft Paper](week_06/course_project_draft_paper.md) (10 points)
- Week 7: [Draft Popular Source](week_07/course_project_draft_popular_source.md) (10 points)
- Week 8: [Final Paper and Popular Source](week_08/course_project_final_paper.md) (10 points)

Course Project assignments are due by the Monday after the listed week by 5 pm. The Final Paper is due by 5 pm on the last day of the course. Late Course Project assignments lose 10% of their grade per day late.
...
#### Week 4. Height and Ancestry: Model Phenotypes and Population Genetics

- Lectures: Monday, Wednesday
- Open Work Session: Friday
- [Lecture Notes: Height](week_04/lecture_notes_height.md)
- [Lecture Notes: Ancestry](week_05/lecture_notes_ancestry.md)
	- Population Genetics
	- Scientific Racism
...
- COURSE PROJECT: [Five Scholarly Source Summaries](week_04/course_project_five_scholarly_source_summaries.md)

### <a name="part_2"></a>Part II: Model Phenotypes

#### Week 5. Schizophrenia and Autism: Psychometrics, Biometrics, and Disability Perspectives

- Lectures: Monday, Wednesday
- Open Work Session: Friday
- [Lecture Notes: Schizophrenia](week_06/lecture_notes_schizophrenia.md)
- [Lecture Notes: Autism](week_07/lecture_notes_autism.md)
...
### <a name="part_3"></a>Part III: Advanced Topics and Ethics

#### Week 6. Causal Reasoning in Substance Use and Aggression
...
- COURSE PROJECT: [Draft Paper](week_06/course_project_draft_paper.md)

#### Week 7. Science Communication and Genetic Engineering

- Lectures: Monday, Wednesday
- Discussion: Friday
- [Lecture Notes: Science Communication](week_11/lecture_notes_science_communication.md)
- [Lecture Notes: Genetic Engineering](week_13/lecture_notes_genetic_engineering.md)
...
- COURSE PROJECT: [Draft Popular Source](week_07/course_project_draft_popular_source.md)

#### Week 8. Applications: Medicine, Education, and Society

- Lectures: Monday, Wednesday
- Final Presentations: Friday
- [Lecture Notes: Personalized Applications](week_14/lecture_notes_personalized_and_direct.md)
- [Lecture Notes: GATTACA](week_15/lecture_notes_gattaca.md)
...
- COURSE PROJECT: [Final Paper and Popular Source](week_08/course_project_final_paper.md)
